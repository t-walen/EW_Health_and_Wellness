...
export default function Home() {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-brown">
      <form className="container max-w-md mx-auto p-6 bg-Pearl rounded-lg shadow-lg" onSubmit={handleSubmit} ref={formRef}>
        <h1 className="text-2xl font-bold mb-6 text-center text-Brown">Get in touch</h1>
        ...
        <div className="button block text-center">
          <button
            type="submit"
            className="px-4 py-2 bg-Brown text-white rounded-lg hover:bg-LightBrown focus:outline-none"
          >
            Submit
          </button>
        </div>
